 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://webservice.app.vaadin.suprised.com/", wsdlLocation = "http://localhost:8888/test?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://webservice.app.vaadin.suprised.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/test?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://webservice.app.vaadin.suprised.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.app.vaadin.suprised.com/", "HelloServicePort"), HelloService.class, features);
    }
